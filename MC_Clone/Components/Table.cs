...
{
    protected event Action<int> RowSelected;
    ...
    public void Draw()
    {
        ...
        DrawAllObject(widths);

        DrawData(null, widths, '+', '-');
    }

    protected void Header(List<int> widths)
    {
        DrawData(null, widths, '+', '-');
        DrawData(headers, widths, '|', ' ');
        DrawData(null, widths, '+', '=');
    }
    protected void DrawAllObject(List<int> widths)
    {
    ...
    protected void CheckSelected(int i)
    {
        if (i == Selected)
        {
    ...
    protected void DrawData(List<string>? data, List<int> widths, char sep, char pad, char start = 'ĉ', char end = 'ĉ')
    {
