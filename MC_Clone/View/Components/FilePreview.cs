...
namespace MC_Clone;
public class FilePreview : IComponent //TODO: Rename to FileViwer
{
    #region Atributes
    ...
    public FilePreview(Application application, FileInfo file, int x = 0, int y = 0)
    {
        Start(application, file, x, y);
    }
    public FilePreview(PreviewWindow parent, Application application, FileInfo file, int x = 0, int y = 0)
    {
        ParentClass = parent;
        Start(application, file, x, y);
    }
